...
namespace Dogware.Objects
{
    class TextObject : GameObject
    {
        ...
        public override void Draw(Microsoft.Xna.Framework.Graphics.SpriteBatch batch)
        {
            ...
            batch.DrawString(TGame.Instance.MainFont, Text, transform.Position, renderer.BlendColor, transform.Rotation, new Vector2(((Text.Length * 24) + (Text.Length * 12)) * Scale, 24 * 2 * Scale), Scale, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0);
        }
    }
}
